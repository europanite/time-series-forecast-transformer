...
The following table shows which versions of `time-series-forecast-transformer` are currently being supported with security updates.
...
We deeply appreciate the efforts of security researchers and contributors who help us improve the security of `time-series-forecast-transformer`.